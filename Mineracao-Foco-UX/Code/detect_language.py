...
# # 7. Boxplot para distribuição de Stars por Categoria
# plt.figure(figsize=(10, 6))
# sns.boxplot(x='category', y='stars', data=df)
# plt.title('Distribuição de Stars por Categoria')
# plt.xlabel('Categoria')
# plt.ylabel('Stars')
# plt.xticks(rotation=45)
# plt.savefig('../Image/boxplot_stars_by_category.png')
# plt.close()

# # 8. Boxplot para distribuição de Forks por Categoria
# plt.figure(figsize=(10, 6))
# sns.boxplot(x='category', y='forks', data=df)
# plt.title('Distribuição de Forks por Categoria')
# plt.xlabel('Categoria')
# plt.ylabel('Forks')
# plt.xticks(rotation=45)
# plt.savefig('../Image/boxplot_forks_by_category.png')
# plt.close()
